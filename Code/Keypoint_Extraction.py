...
from Code.weight_init import init_pretrained_weights

from new_resnet import ResNet_18_Orange , BasicBlock
from classifier import ConvnetPlusClassifier
...
class KeypointsExtractionModule_Resnet18(nn.Module):
    def __init__(self, soft_local_max_size=3, args=None):
        ...
        init_pretrained_weights(base,model_urls['resnet18'])
        ...
        self.pad = soft_local_max_size // 2
...
def IAM():
    iam_module = KeypointsExtractionModule_Resnet18(
        soft_local_max_size = 3, 
        args=None
    )
    return iam_module
